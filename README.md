...
[Visus.DirectoryAuthentication](Visus.DirectoryAuthentication) is a drop-in replacement for [Visus.LdapAuthentication](Visus.LdapAuthentication) using [System.DirectorySerices.Protocols](https://learn.microsoft.com/de-de/dotnet/api/system.directoryservices.protocols) which is a platform-independent implementation of LDAP services since .NET 5.
