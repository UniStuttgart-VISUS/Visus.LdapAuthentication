...
> [!NOTE]
> Visus.DirectoryAuthentication uses the attribute "SearchBase" for the `IDictionary<string, System.DirectoryServices.Protocols.SearchScope>` and does not provide the option to configure a single search base via "SearchBase" and "IsSubtree".
