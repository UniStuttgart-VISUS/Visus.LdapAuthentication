...
namespace Visus.DirectoryAuthentication {
    ...
    public interface ILdapMapper<TUser, TGroup> {
        ...
        TUser Assign(SearchResultEntry entry, LdapConnection connection,
            TUser user);
        ...
        /// or if <paramref name="entry"/> is <c>null</c>,
        /// or if <paramref name="connection"/> is <c>null</c>.</exception>
        TGroup Assign(SearchResultEntry entry, LdapConnection connection,
            TGroup group);
        ...
        TUser Assign(IEnumerable<Claim> claims, TUser user);
