...
namespace Visus.LdapAuthentication {
    ...
    public interface ILdapSearchService {
        ...
        /// <returns>All users in the directory matching the given search
        /// criteria.</returns>
        IEnumerable<ILdapUser> GetUsers(string searchBase,
    ...
    /// <summary>
    /// Stronlgy typed variant of <see cref="ILdapSearchService"/> that returns
    /// a specific type of user.
    /// </summary>
    /// <typeparam name="TUser">The type of the LDAP user to use.</typeparam>
    public interface ILdapSearchService<TUser> : ILdapSearchService
        ...
        /// <returns>All users in the directory matching the given search
        /// criteria.</returns>
        new IEnumerable<TUser> GetUsers(string searchBase,
            SearchScope searchScope, string filter);
    }
}
